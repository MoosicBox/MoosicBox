...
${include('rust/test-selection-criteria')}

${include('rust/test-conventions', { package_name: package_name })}

${include('rust/dependency-management')}

${include('rust/verification-checklist', { package_name: package_name, run_tests: true })}
