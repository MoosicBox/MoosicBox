...
mod tests {
    ...
    #[test]
    fn test_queue_bounce_string_types() {
        // Clear any existing actions
        ACTIONS.lock().unwrap().clear();

        queue_bounce("string_literal");
        queue_bounce(String::from("owned_string"));
        queue_bounce(String::from("string_ref"));
