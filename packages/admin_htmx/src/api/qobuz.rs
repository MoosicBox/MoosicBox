...
mod tests {
    ...
    #[cfg(feature = "scan")]
    #[test]
    fn test_settings_logged_in_with_scan() {
        let result = settings_logged_in(true);
        let html = result.into_string();

        assert!(html.contains("Logged in!"));
        assert!(html.contains("Run Scan"));
        assert!(html.contains("hx-post=\"/admin/qobuz/run-scan\""));
    }

    #[cfg(feature = "scan")]
    #[test]
    fn test_settings_logged_in_without_scan() {
        let result = settings_logged_in(false);
        let html = result.into_string();
    ...
    #[cfg(not(feature = "scan"))]
    #[test]
    fn test_settings_logged_in_no_scan_feature() {
        let result = settings_logged_in();
        let html = result.into_string();
    ...
    #[test]
    fn test_settings_logged_out_without_message() {
        let result = settings_logged_out(None);
        let html = result.into_string();

        assert!(html.contains("hx-post=\"/admin/qobuz/auth/user-login\""));
    ...
    #[test]
    fn test_settings_logged_out_with_message() {
        let message = html! { p { "Custom error message" } };
        let result = settings_logged_out(Some(message));
        let html = result.into_string();
    ...
    #[test]
    fn test_settings_logged_out_has_autocomplete() {
        let result = settings_logged_out(None);
        let html = result.into_string();
