...
mod tests {
    ...
    #[test]
    fn test_clear_input_with_id_selector() {
        let result = clear_input("#my-input");
        assert_eq!(result, "document.querySelector('#my-input').value = ''");
    }

    #[test]
    fn test_clear_input_with_class_selector() {
        let result = clear_input(".my-class");
        assert_eq!(result, "document.querySelector('.my-class').value = ''");
    }

    #[test]
    fn test_clear_input_with_attribute_selector() {
        let result = clear_input("[name='username']");
        assert_eq!(
            result,
    ...
    #[test]
    fn test_clear_input_with_complex_selector() {
        let result = clear_input("form#login-form input.username");
        assert_eq!(
            result,
            "document.querySelector('form#login-form input.username').value = ''"
        );
    }

    #[test]
    fn test_clear_input_with_empty_selector() {
        let result = clear_input("");
        assert_eq!(result, "document.querySelector('').value = ''");
    }
}
