    ...
    ($module:ident $(,)?) => {
        ...
        pub mod sync {
            pub use $crate::$module::sync::{
                File, canonicalize, create_dir, create_dir_all, read_dir_sorted, read_to_string,
    ...
    ($module:ident $(,)?) => {
        ...
        pub mod unsync {
            pub use $crate::$module::unsync::{
                ...
                exists, is_dir, is_file, read_dir, read_dir_sorted, read_to_string, remove_dir_all,
