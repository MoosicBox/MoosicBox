...
mod tests {
    ...
    fn test_api_download_task_to_value_type_from_json() {
        ...
        let json = serde_json::json!({
            ...
            "title": "Test Track",
            "contains_cover": true,
            "file_path": "/nonexistent/music/test.flac",
        ...
        assert_eq!(task.file_path, "/nonexistent/music/test.flac");
    ...
    fn test_api_download_task_to_value_type_from_json_with_null_total_bytes() {
        ...
        let json = serde_json::json!({
            ...
            "title": "Test Album",
            "contains_cover": true,
            "file_path": "/nonexistent/music/cover.jpg",
            "total_bytes": null
        });
        ...
        // Since file doesn't exist, bytes should be 0
