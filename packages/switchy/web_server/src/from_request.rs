...
//! use switchy_web_server::from_request::{FromRequest, RequestData};
//!
...
///
/// ```rust
/// use switchy_web_server::{HttpRequest, from_request::FromRequest};
///
/// struct MyExtractor {
///     value: String,
/// }
...
///     type Error = switchy_web_server::Error;
///
...
///
/// ```rust,ignore
/// use switchy_web_server::{RequestData, HttpResponse, from_request::FromRequest};
///
...
///
/// ```rust,ignore
/// use switchy_web_server::{Query, HttpResponse};
...
///
/// ```rust,ignore
/// use switchy_web_server::{Json, HttpResponse};
/// use serde::Deserialize;
///
/// #[derive(Deserialize)]
/// struct CreateUser {
...
///
/// ```rust,ignore
/// use switchy_web_server::{Headers, HttpResponse};
///
...
///
/// ```rust,ignore
/// use switchy_web_server::{RequestInfo, HttpResponse};
///
