...
pub mod service {
    //! Async service types generated for the bundled app lifecycle.
    //!
    //! This module contains the generated `Service`, `Handle`, and related
    //! service infrastructure used to process [`super::Command`] values.
