...
pub use hyperchad_template_macros::html;
...
///
/// ```rust
/// use hyperchad_template::Escaper;
/// use std::fmt::Write;
...
///
/// ```rust
/// use hyperchad_template::{html, Markup, Render};
///
...
/// let markup = html! {
///     "My IP address is: "
///     (hyperchad_template::display(ip_address))
/// };
///
...
///
/// ```rust
/// use hyperchad_template::{DOCTYPE, html};
///
/// let markup = html! {
///     (DOCTYPE)
///     html {
