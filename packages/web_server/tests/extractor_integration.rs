...
mod basic_test_utils {
    ...
    #[allow(dead_code)]
    pub fn create_test_state_container() -> moosicbox_web_server::extractors::StateContainer {
...
mod serde_test_utils {
    ...
    #[cfg(feature = "simulator")]
    #[allow(dead_code)]
    pub fn create_comprehensive_test_request() -> moosicbox_web_server::simulator::SimulationRequest
    {
        use bytes::Bytes;
        use moosicbox_web_server::Method;
        use moosicbox_web_server::simulator::SimulationRequest;
