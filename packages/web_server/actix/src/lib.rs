//! Actix Web backend for `moosicbox_web_server`.
//!
//! This crate provides the Actix Web implementation for the `moosicbox_web_server` framework.
...
//! use moosicbox_web_server_actix::WebServerBuilderActixExt;
//!
